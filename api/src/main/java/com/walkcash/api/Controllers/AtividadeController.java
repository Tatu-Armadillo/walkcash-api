...
public class AtividadeController {
    ...
    @GetMapping
    public Page<AtividadeModel> visualizarAtividades(@RequestParam(required = false) Long idAtividade, @PageableDefault(sort = "idAtividade", direction = Direction.ASC) Pageable page ) {
